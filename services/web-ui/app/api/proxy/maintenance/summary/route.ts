...
const log = logger.child({ route: '/api/proxy/maintenance/summary' });

export const runtime = 'nodejs';
export const dynamic = 'force-dynamic';

/**
 * GET /api/proxy/maintenance/summary
 * Proxies to GET /api/v1/maintenance/summary.
 */
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    const res = await fetch(`${apiGatewayUrl}/api/v1/maintenance/summary`, {
      method: 'GET',
