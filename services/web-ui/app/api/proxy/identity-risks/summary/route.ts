...
const log = logger.child({ route: '/api/proxy/identity-risks/summary' });

export const runtime = 'nodejs';
export const dynamic = 'force-dynamic';

/**
 * GET /api/proxy/identity-risks/summary
 * Proxies to GET /api/v1/identity-risks/summary.
 */
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    const res = await fetch(`${apiGatewayUrl}/api/v1/identity-risks/summary`, {
      method: 'GET',
