...
async def get_patch_assessment(
    ...
    kql = (
        ...
        "        criticalCount = coalesce(toint(properties.availablePatchCountByClassification.Critical), 0),\n"
        "        securityCount = coalesce(toint(properties.availablePatchCountByClassification.Security), 0),\n"
        "        updateRollupCount = coalesce(toint(properties.availablePatchCountByClassification.UpdateRollup), 0),\n"
        "        featurePackCount = coalesce(toint(properties.availablePatchCountByClassification.FeaturePack), 0),\n"
        "        servicePackCount = coalesce(toint(properties.availablePatchCountByClassification.ServicePack), 0),\n"
        "        definitionCount = coalesce(toint(properties.availablePatchCountByClassification.Definition), 0),\n"
        "        toolsCount = coalesce(toint(properties.availablePatchCountByClassification.Tools), 0),\n"
        "        updatesCount = coalesce(toint(properties.availablePatchCountByClassification.Updates), 0)\n"
